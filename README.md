<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="854" height="220" style="z-index:1;position:relative" viewBox="0 0 854 220">
        <style>
      .text {   font-size: 64px;   font-weight: 700;   font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji;  } .desc {   font-size: 17px;   font-weight: 500;   font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji;  } 
      .text, .desc {   animation: twinkling 4s ease-in-out infinite;  } @keyframes twinkling {   40% {     opacity: 1;   }   50% {     opacity: 0.5;   }   60% {     opacity: 1;   }   70% {     opacity: 0.5;   }   80% {     opacity: 1;   }  } 
        ...
        <defs>
              <linearGradient id="linear" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stop-color="#0d1117"/><stop offset="40%" stop-color="#0a1628"/><stop offset="70%" stop-color="#0d1f3c"/><stop offset="100%" stop-color="#0d1117"/>
              </linearGradient>
            </defs>
        
      <g transform="translate(427, 110)">
        <path id="myPath" fill="url(#linear)" d="M52.8,-67C68,-61.6,79.7,-45.6,82.5,-28.7C85.4,-11.8,79.5,6,71.4,20.8C63.2,35.5,53,47.1,40.7,53.3C28.5,59.4,14.2,60,-2.1,63C-18.5,65.9,-37,71.2,-52.3,66C-67.6,60.9,-79.7,45.4,-81.5,29C-83.2,12.7,-74.6,-4.4,-68.7,-22.2C-62.8,-40.1,-59.5,-58.7,-48.4,-65.4C-37.4,-72.2,-18.7,-67.1,0,-67.1C18.8,-67.2,37.6,-72.4,52.8,-67Z">
         ...
         <text text-anchor="middle" alignment-baseline="middle" x="50%" y="42%" class="text" style="fill:#E6EDF3;" stroke="#1F6FEB" stroke-width="1">Parth Parmar</text>
        <text text-anchor="middle" alignment-baseline="middle" x="50%" y="62%" class="desc" style="fill:#E6EDF3;">MERN · Backend · AI/ML</text>
      </svg>
